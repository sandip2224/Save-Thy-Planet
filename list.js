const blogs = [
    ...
    },
    {
        ...
        url: "images/blog/blog_03.jpg"
    },
    {
        title: "Rajah Scops Owl rediscovered in Borneo",
        small: "An unexpected discovery confirming the existence of O. brookii brookii has sparked new interest in finding the owl again",
        desc: "In 2009 a team, led by Thomas Martin and including avian ecologist Andy Boyce, began observing birds and searching for nests in and around Kinabalu Park in Sabah, a Malaysian state in Borneo, as part of a decade-long project. A year in, on May 4, 2016, one member of the group, Keegan Tranquillo, came across an owl which looked distinctly different to others on the site, and quickly alerted Boyce to the unusual individual. “I was pretty convinced immediately that it was a[Rajah Scops Owl],” says Boyce, who is currently an ecologist at the Smithsonian Conservation Biology Institute. “I knew of the owl, I knew that there was a possibility that it should occur somewhere on Mount Kinabalu, but there was no concerted effort to survey specifically for this bird.” The owl was found roosting about a meter above the ground near a small bank.Boyce and his colleagues made the most of the rare opportunity, snapping as many photos of the individual as they could – the first ever images of O.brookii brookii.Though it may be notoriously difficult to find, once spotted, it is relatively easy to distinguish it from the Mountain Scops Owl that is common in the region, says Boyce.The Rajah species is larger in size and has distinctly orange irises, as well as the small ear tufts characteristic of Scops Owls in general.It also has a speckled brown and black crown.",
        url: "images/blog/blog_04.jpg"
    }
]
...
const animals = [
    {
        ...
        desc: "The African forest elephant is one of the two living African elephant species."
    },
    {
        name: "Amur Leopard",
        url: "images/slider/amur-leopard.jpg",
        desc: "The Amur leopard is a leopard subspecies native to the Primorye region of southeastern Russia and northern China."
    }, {
        name: "Black Rhino",
        url: "images/slider/black-rhino.jpg",
        desc: "The black rhinoceros or hook-lipped rhinoceros is a species of rhinoceros, native to eastern and southern Africa including Angola, Botswana, Kenya, Malawi, Mozambique, Namibia, South Africa, Eswatini, Tanzania, Zambia, and Zimbabwe."
    },
    {
        name: "Bornean Orangutan",
        url: "images/slider/bornean-orangutan.jpg",
        desc: "The Bornean orangutan is a species of orangutan native to the island of Borneo."
    },
    {
        name: "Cross River Gorilla",
        url: "images/slider/cross-river-gorilla.jpg",
        desc: "The Cross River gorilla is a subspecies of the western gorilla. It was named a new species in 1904 by Paul Matschie, a mammalian taxonomist working at the Humboldt University Zoological Museum in Berlin."
    },
    {
        name: "Hawksbill Turtle",
        url: "images/slider/hawksbill-turtle.jpg",
        desc: "The hawksbill sea turtle is a critically endangered sea turtle belonging to the family Cheloniidae."
    },
    {
        name: "Javan Rhino",
        url: "images/slider/javan-rhino.jpg",
        desc: "The Javan rhinoceros, also known as the Sunda rhinoceros or lesser one-horned rhinoceros, is a very rare member of the family Rhinocerotidae."
    },
    {
        name: "Orangutan",
        url: "images/slider/orangutan.jpg",
        desc: "Orangutans are great apes native to the rainforests of Indonesia and Malaysia. They are now found only in parts of Borneo and Sumatra, but during the Pleistocene they ranged throughout Southeast Asia."
    },
    {
        name: "Saola",
        url: "images/slider/saola.jpg",
        desc: "The saola, also called spindlehorn, Asian unicorn, or infrequently, Vu Quang bovid, is one of the world's rarest large mammals."
    },
    {
        name: "Sumatran Rhino",
        url: "images/slider/sumatran-rhino.jpg",
        desc: "The Sumatran rhinoceros, also known as the hairy rhinoceros or Asian two-horned rhinoceros, is a rare member of the family Rhinocerotidae and one of five extant species of rhinoceros."
    }
]
